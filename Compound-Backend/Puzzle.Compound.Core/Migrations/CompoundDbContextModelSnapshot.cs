...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.CompoundCall", b =>
                {
                    b.Property<Guid>("CompoundCallId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("CompoundCallId");

                    b.HasIndex("CompoundId");

                    b.HasIndex("OwnerRegistrationId");

                    b.ToTable("CompoundCalls");
                });
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.NotificationSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.NotificationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.RegistrationForUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.ServiceRequest", b =>
                {
                    ...
                    b.Property<decimal>("ServiceSubTypesTotalCost")
                        .HasPrecision(18, 2)
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.ServiceRequestSubType", b =>
                {
                    b.Property<Guid>("ServiceRequestSubTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
                    ...
                    b.Property<decimal>("ServiceSubTypeCost")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid>("ServiceSubTypeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ServiceSubTypeQuantity")
                        .HasColumnType("int");

                    b.HasKey("ServiceRequestSubTypeId");

                    b.HasIndex("ServiceRequestId");

                    b.HasIndex("ServiceSubTypeId");

                    b.ToTable("ServiceRequestSubTypes");
                });

            modelBuilder.Entity("Puzzle.Compound.Core.Models.ServiceSubType", b =>
                {
                    b.Property<Guid>("ServiceSubTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.NotificationUser", b =>
                {
                    b.HasOne("Puzzle.Compound.Core.Models.NotificationSchedule", "NotificationSchedule")
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.RegistrationForUser", b =>
                {
                    b.HasOne("Puzzle.Compound.Core.Models.OwnerRegistration", "User")
                        .WithMany("RegistrationForUsers")
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.ServiceRequestSubType", b =>
                {
                    b.HasOne("Puzzle.Compound.Core.Models.ServiceRequest", "ServiceRequest")
                        .WithMany("ServiceRequestSubTypes")
                        .HasForeignKey("ServiceRequestId")
                        .IsRequired();

                    b.HasOne("Puzzle.Compound.Core.Models.ServiceSubType", "ServiceSubType")
                        .WithMany("ServiceRequestSubTypes")
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.ServiceSubType", b =>
                {
                    b.HasOne("Puzzle.Compound.Core.Models.CompoundService", "CompoundService")
                        .WithMany("ServiceSubTypes")
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.OwnerRegistration", b =>
                {
                    ...
                    b.Navigation("RegistrationForUsers");
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.ServiceRequest", b =>
                {
                    ...
                    b.Navigation("ServiceRequestSubTypes");
                });
