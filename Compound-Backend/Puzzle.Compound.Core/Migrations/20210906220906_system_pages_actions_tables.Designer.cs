...
namespace Puzzle.Compound.Core.Migrations
{
    ...
    [Migration("20210906220906_system_pages_actions_tables")]
    partial class system_pages_actions_tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.CompoundUnit", b =>
                {
                    ...
                    b.Property<Guid>("CompoundUnitTypeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.UsersInCompanyRoles", b =>
                {
                    b.Property<Guid>("UserCompanyRoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.ActionsInCompanyRoles", b =>
                {
                    b.HasOne("Puzzle.Compound.Core.Models.CompanyUserRole", "CompanyUserRoles")
                        .WithMany("ActionsInCompanyRoles")
                        .HasForeignKey("CompanyUserRoleId")
                        .IsRequired();
            ...
            modelBuilder.Entity("Puzzle.Compound.Core.Models.CompanyRole", b =>
                {
                    ...
                    b.Navigation("UsersInCompanyRoles");
                });
